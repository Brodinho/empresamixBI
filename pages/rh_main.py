...
from modules.rh.views.visualizations import (
    recrutamento,
    desempenho,
    treinamento,
    folha
...
def load_rh_module():
    logger.debug("=== INICIANDO MÓDULO RH ===")
    
    # Configuração DEVE ser a primeira chamada Streamlit
    st.set_page_config(
        page_title="Módulo RH",
        layout="wide",
    ...
    menu_items = {
        "Recrutamento e Seleção": recrutamento.render,
        "Avaliação de Desempenho": desempenho.render,
        "Treinamento e Desenvolvimento": treinamento.render,
        "Folha de Pagamento": folha.render
    }
...
if __name__ == "__main__":
    try:
        ...
        logger.error(f"Erro ao carregar módulo RH: {str(e)}") 