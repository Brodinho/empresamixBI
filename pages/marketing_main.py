...
from modules.marketing.views.visualizations import (
    campanhas,
    midias_sociais,
    funil,
    roi_marketing
...
def load_marketing_module():
    logger.debug("=== INICIANDO MÓDULO MARKETING ===")
    
    # Configuração DEVE ser a primeira chamada Streamlit
    st.set_page_config(
        page_title="Módulo Marketing",
        layout="wide",
    ...
    menu_items = {
        "Campanhas de Marketing": campanhas.render,
        "Análise de Mídias Sociais": midias_sociais.render,
        "Funil de Marketing": funil.render,
        "ROI de Marketing": roi_marketing.render
    }
...
if __name__ == "__main__":
    try:
        load_marketing_module()
    except Exception as e:
        logger.error(f"Erro ao carregar módulo marketing: {str(e)}")